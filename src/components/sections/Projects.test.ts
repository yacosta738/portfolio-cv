...
test('Projects component renders a list of projects', async () => {
  ...
  expect(project1.querySelector('a[href="https://example.com/project1"]')).not.toBeNull();
  expect(project1.querySelector('a[href="https://github.com/user/project1"]')).not.toBeNull();
